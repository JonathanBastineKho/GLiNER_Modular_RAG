...
DATA_DIR = os.path.join(os.path.dirname(__file__), "..", "..", "crossNER_data", "ai")
OUTPUT_DIR = os.path.join(os.path.dirname(__file__), "..", "..", "data", "crossNER_ai")


def parse_conll(filepath):
    """Parse CoNLL-style file (token\tBIO-tag per line, blank lines separate sentences)."""
    sentences = []
    tokens = []
    tags = []
